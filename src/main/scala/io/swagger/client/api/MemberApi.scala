...
trait MemberApi extends Service {


  final override def descriptor = {
    import Service._
    named("MemberApi").withCalls(
  ...
  /**
    ...
    * @return ListOfUsers Body Parameter  The username to be added.  
    */
  def addUserInChatRoom(chatRoomName: String): ServiceCall[User ,ListOfUsers]
